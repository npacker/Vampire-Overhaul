...
;BEGIN CODE
PlayerVampireFeedController.HandleSleepingBiteLeft(akTargetRef as Actor, abFeed = True)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
PlayerVampireFeedController.HandleBite(akTargetRef as Actor, abFeed = True)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
PlayerVampireFeedController.HandleSleepingBite(akTargetRef as Actor, abFeed = True)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
PlayerVampireFeedController.HandleCombatBite(akTargetRef as Actor, abFeed = True)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
PlayerVampireFeedController.HandleSleepingBiteRight(akTargetRef as Actor, abFeed = True)
;END CODE
EndFunction
;END FRAGMENT
